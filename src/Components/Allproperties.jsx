...
const Allproperties = (props) => {
  ...
  const [budgetFilter, setBudgetFilter] = useState(
    parseInt(searchParams.get("budget")) || 50000
  );
  ...
  useEffect(() => {
    // Update the URL when filter states change
    ...
    // Apply filters based on filter state changes
    applyFilters();
  ...
  const applyFilters = () => {
    const filtered = properties.filter((property) => {
      ...
      if (locationFilter === "All" || locationFilter ==="all") {
        ...
        console.log(lowercaseArea,locationFilter)
      }
      let budgetMatches = true;
      if (property.type==="sharing flat") {
       budgetMatches = property.rentEachHead <= parseInt(budgetFilter);
      }else{
        budgetMatches = property.rent <= parseInt(budgetFilter);
      }
  ...
  useEffect(() => {
    // Call applyFilters only after properties have been fetched and set
                  ...
                  <div className="col-md-6" id="propertyCard-body">
                    ...
                    >
                      ...
                      <div id="card-location" className="row">
                        ...
                        <div className="/particular-property/Hide col">
